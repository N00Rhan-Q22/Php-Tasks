...
if (isset($_POST['review'])) {
    $rev->setUser_id($_SESSION['user']->id);
    $rev->setProduct_id($_GET['product']);
    $rev->setValue($_POST['value']);
    $rev->setComment($_POST['comment']);
    $resNewRev = $rev->insertReview();
    if ($resNewRev) {
                ...
                <div class="product-details-content">
                    ...
                    <div class="rating-review">
                        <div class="pro-dec-rating">
                            <?php for ($i = 1; $i <= $product->rev_avg; $i++) { ?>
                                <i class="ion-android-star-outline theme-star"></i>
                            <?php }
                            for ($i = 1; $i <= (5 - $product->rev_avg); $i++) { ?>
            ...
            <div class="tab-content description-review-bottom">
                ...
                <div id="des-details3" class="tab-pane">
                    <div class="rattings-wrapper">
                        ...
                        $revResult = $productObject->getProductReviews();
                        if ($revResult->num_rows >= 1) {
                            $rev = $revResult->fetch_all(MYSQLI_ASSOC);
                            ...
                            ?>
                            <div class="sin-rattings">
                                <div class="alert-warning alert text-center"> No rev Found To This Product </div>
                            </div>
                        <?php } ?>

                    </div>
                    <?php
                    if (isset($_SESSION['user']) && !in_array( $_SESSION['user']->id,array_column($rev,'user_id'))) { ?>
