...
$recentProResult = $products->mostRecentProducts();
$ratedProResult = $products->mostRatedProducts();
if ($recentProResult) {
	$recentProduct = $recentProResult->fetch_all(MYSQLI_ASSOC);
} else {
	$recentProduct = [];
}
if ($ratedProResult) {
	$ratedProduct = $ratedProResult->fetch_all(MYSQLI_ASSOC);
} else {
	$ratedProduct = [];
}
?>
...
<div class="slider-area">
	<div class="slider-active owl-dot-style owl-carousel">
		<div class="single-slider ptb-240 bg-img" style="background-image:url(assets/img/slider/Ecommerce.jpg);">
			<div class="container">
				<div class="slider-content slider-animated-1">
					<h1 class="animated">Want to Shop <span class="theme-color text-primary">Easily</span></h1>
					<h1 class="animated">Your Place is HERE.</h1>
		...
		<div class="tab-content jump">
			<div class="tab-pane active">
				<div class="row w-100 h-100">
					<?php
					foreach ($recentProduct as $index => $product) { ?>
						<div class="col-3">
							<div class="product-wrapper mb-30 w-100 h-100">
								<div class="product-img w-100 h-75">
									<a href="product-details.html">
										<img alt="" class="w-100 h-100" src="assets/img/product/<?= $product['imgage'] ?>">
									</a>
									<span>-30%</span>
	...
	<div class="container">
		...
		<div class="tab-content jump">
			<div class="tab-pane active">
				<div class="row w-100 h-100">
					<?php
					foreach ($ratedProduct as $index => $productRated) { ?>
						<div class="col-3">
							<div class="product-wrapper mb-30 w-100 h-100">
								<div class="product-img w-100 h-75">
									<a href="product-details.html">
										<img alt="" class="w-100 h-100" src="assets/img/product/<?= $productRated['img'] ?>">
									</a>
									<span>-30%</span>
									<div class="product-action">
										<a class="action-wishlist" href="#" title="Wishlist">
								...
								<div class="product-content text-left">
									<div class="product-hover-style">
										<div class="product-title">
											<h4>
												<a href="product-details.html"><?= $productRated['name_en'] ?></a>
											</h4>
										</div>
										<div class="cart-hover">
											<h4><a href="product-details.html">+ Add to cart</a></h4>
	...
	<div class="container">
		<div class="brand-logo-active owl-carousel">
			<div class="single-brand-logo">
				<img style="max-width: 170px; max-height: 100px;" alt="samsung" src="assets/img/brand-logo/samsung.png">
			</div>
			<div class="single-brand-logo">
				<img style="max-width: 170px; max-height: 100px;" alt="dell" src="assets/img/brand-logo/dell.png">
			</div>
			<div class="single-brand-logo">
				<img style="max-width: 170px; max-height: 100px;" alt="apple" src="assets/img/brand-logo/apple.png">
			</div>
			<div class="single-brand-logo">
				<img style="max-width: 170px; max-height: 100px;" alt="loreal" src="assets/img/brand-logo/loreal.jpg">
			</div>
			<div class="single-brand-logo">
				<img style="max-width: 170px; max-height: 100px;" alt="dior" src="assets/img/brand-logo/dior.png">
			</div>
			<div class="single-brand-logo">
				<img style="max-width: 170px; max-height: 100px;" alt="hp" src="assets/img/brand-logo/hp.png">
			</div>
		</div>
	</div>
</div>
