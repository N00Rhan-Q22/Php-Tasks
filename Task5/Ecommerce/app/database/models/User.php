...
{
    private $id, $first_name, $last_name, $email, $password, $phone, $gender, $status,
        $image, $code, $verified_at, $expired_at, $created_at, $updated_at, $code_expired_at, $email_verified_at,$rememberToken;
